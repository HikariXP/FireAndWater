...
namespace TarodevController {
    ...
    public class PlayerController : MonoBehaviour, IPlayerController 
    {
        ...
        //In order to adapt from listening arrow input to key input
        private static float GetADInput()
        {
        ...
        private static float GetArrowInput()
        {
        ...
        private void GatherInput() {
            ...
            #region Standard Input Context

            //Input = new FrameInput
            //{
            //    JumpDown = UnityEngine.Input.GetButtonDown("Jump"),
            //    JumpUp = UnityEngine.Input.GetButtonUp(""),
